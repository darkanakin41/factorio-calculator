...
final class Version20200224200753 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE factorio_product_component DROP FOREIGN KEY FK_275E17DA4584665A');
        $this->addSql('ALTER TABLE factorio_product_component DROP FOREIGN KEY FK_275E17DAE2ABAFFF');
        $this->addSql('DROP TABLE factorio_product_component');
        $this->addSql('DROP TABLE factorio_product');
    }
}
